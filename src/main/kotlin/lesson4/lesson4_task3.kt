...
fun main() {
    ...
    val likelyConditions = (currentSun == IS_SUNNY) && (currentAwningState == IS_AWNING_OPEN) && (currentAirHumidityInPercents == REQUIRED_AIR_HUMIDITY_IN_PERCENTS) && (currentSeason != BAD_SEASON)
